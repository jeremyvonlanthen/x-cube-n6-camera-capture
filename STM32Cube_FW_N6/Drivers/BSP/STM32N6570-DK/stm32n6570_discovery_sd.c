/**
  ******************************************************************************
  * @file    stm32n6570_discovery_sd.c
  * @author  MCD Application Team
  * @brief   This file includes the uSD card driver mounted on STM32N6570_DK
  *          boards.
  ******************************************************************************
  * @attention
  *
...
/** @defgroup STM32N6570_DK_SD_Private_TypesDefinitions SD Private TypesDefinitions
  * @{
  */
...
typedef void (*BSP_SD_EXTI_LineCallback)(void);
/**
  * @}
  */

/** @defgroup STM32N6570_DK_SD_Exported_Variables SD Exported Variables
  * @{
  */
...
/** @defgroup STM32N6570_DK_SD_Private_Variables SD Private Variables
  * @{
  */
...
/** @defgroup STM32N6570_DK_SD_Private_Functions_Prototypes SD Private Functions Prototypes
  * @{
  */
...
/** @defgroup STM32N6570_DK_SD_Exported_Functions SD Exported Functions
  * @{
  */
...
int32_t BSP_SD_Init(uint32_t Instance)
{
  ...
  /* SDMMC1 activation  and security configuration */
  {
    ...
    uint32_t data;
    /*SDMMC1*/
     /* set MPRIV, MSEC and MCID=001 (same CID as CPU) */
     *(uint32_t*)RIFSCAddress1 = 0x00000310;
     /* readback data */
     ...
     data = *(uint32_t*)RIFSCAddress1 ;
     *(uint32_t*)RIFSCAddress1 = data | 0x00200000U;
     /* readback data */
     data = *(uint32_t*)RIFSCAddress1 ;
     (void)data;
    ...
    /*SDMMC2*/
     /* set MPRIV, MSEC and MCID=001 (same CID as CPU) */
     *(uint32_t*)RIFSCAddress2 = 0x00000310;
     /* readback data */
     ...
     RIFSCAddress2 = 0x54024014; /* RIFSC_RISC_SECCFGRx with x = 1 */
     data = *(uint32_t*)RIFSCAddress2 ;
...
int32_t BSP_SD_DetectITConfig(uint32_t Instance)
{
  int32_t ret;
  GPIO_InitTypeDef gpio_init_structure;
  static BSP_SD_EXTI_LineCallback SdCallback[SD_INSTANCES_NBR] = {SD_EXTI_Callback};
...
/** @defgroup STM32N6570_DK_SD_Private_Functions SD Private Functions
  * @{
  */
#if (USE_HAL_SD_REGISTER_CALLBACKS > 0)
/**
