...
__STATIC_FORCEINLINE void CVT_DualPelRgbToYuv(uint8_t *r, uint8_t *g, uint8_t *b, int32_t *y, int32_t *cb, int32_t *cr)
{
...
static void CVT_CvtGreyToMcu422(uint8_t *p_dst, uint8_t *p_src, int pitch, int x_limit, int y_limit)
{
  uint8_t *p_dst_l[2];
  int32_t luma;
  int x, y;
...
static void CVT_CvtArgbToMcu422(uint8_t *p_dst, uint8_t *p_src, int pitch, int x_limit, int y_limit)
{
...
static void CVT_CvtrgbToMcu422(uint8_t *p_dst, uint8_t *p_src, int pitch, int x_limit, int y_limit)
{
...
static void CVT_CvtYuv422ToMcu422(uint8_t *p_dst, uint8_t *p_src, int pitch, int x_limit, int y_limit)
{
...
static void CVT_CvtRgb565ToMcu422(uint8_t *p_dst, uint8_t *p_src, int pitch, int x_limit, int y_limit)
{
...
static void CVT_FormatToYuv422Jpeg(uint8_t *p_dst, uint8_t *p_src, int width, int height, int byte_per_pel,
